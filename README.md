...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,347 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-28 - A reference implementation of GraphQL for JavaScript.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,958 | 🐛 858 | 🌐 Rust | 📅 2026-08-28 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,967 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-22 - A simple caching GraphQL client for React.
* [graphql-hooks](https://github.com/nearform/graphql-hooks) ⭐ 1,886 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-28 - Minimal hooks-first GraphQL client with caching and server-side rendering support.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,947 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-28 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,526 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-20 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 103 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-24 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,966 | 🐛 175 | 🌐 TypeScript | 📅 2026-08-22, [Zod](https://github.com/colinhacks/zod) ⭐ 43,557 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-28, or [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-28.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 117 | 🌐 TypeScript | 📅 2026-08-27 - Tool library for building and maintaining GraphQL-JS servers.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,565 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,256 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-28 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-compose](https://github.com/graphql-compose/graphql-compose) ⭐ 1,210 | 🐛 86 | 🌐 TypeScript | 📅 2026-08-27 - Tool which allows you to construct flexible graphql schema from different data sources via plugins.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,973 | 🐛 3,638 | 🌐 JavaScript | 📅 2026-08-28 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,671 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-23 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-28 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-08-28 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,792 | 🐛 80 | 🌐 PHP | 📅 2026-08-28 - GraphQL API for WordPress.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,706 | 🐛 310 | 🌐 Python | 📅 2026-08-28 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,342 | 🐛 37 | 🌐 Python | 📅 2026-08-06 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 530 | 🐛 30 | 🌐 Python | 📅 2026-08-27 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,223 | 🐛 39 | 🌐 Java | 📅 2026-08-24 - GraphQL Java implementation.
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 228 | 🐛 23 | 🌐 Java | 📅 2026-08-28 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,152 | 🐛 21 | 🌐 Go | 📅 2026-08-28: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,961 | 🐛 66 | 🌐 Scala | 📅 2026-08-28 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 28 | 🌐 Scala | 📅 2026-08-28 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,752 | 🐛 374 | 🌐 C# | 📅 2026-08-28 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,144 | 🐛 170 | 🌐 F# | 📅 2026-08-28
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,104 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,929 | 🐛 163 | 🌐 TypeScript | 📅 2026-08-28 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,970 | 🐛 106 | 🌐 Rust | 📅 2026-08-28 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,683 | 🐛 249 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-08-28 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,616 | 🐛 1,824 | 🌐 JavaScript | 📅 2026-08-28 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-08-28 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,802 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - A Burp Extension for GraphQL Security Testing
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,566 | 🐛 2,578 | 🌐 TypeScript | 📅 2026-08-28 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,465 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-28 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-28 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,732 | 🐛 1,139 | 🌐 Rust | 📅 2026-08-28
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,758 | 🐛 691 | 🌐 Go | 📅 2026-08-28 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,272 | 🐛 245 | 🌐 Python | 📅 2026-08-28 - GraphQL-first headless e-commerce platform.

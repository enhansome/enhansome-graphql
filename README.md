...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,583 | 🐛 196 | 🌐 JavaScript | 📅 2026-08-14 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 426 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-14 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,690 | 🐛 3 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,344 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-13 - A reference implementation of GraphQL for JavaScript.
* [graphql-jit](https://github.com/zalando-incubator/graphql-jit) ⭐ 1,083 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-27 - GraphQL execution using a JIT compiler.
* [Gra*fast*](https://grafast.org) - a cutting edge planning and execution engine for GraphQL.

#### Clients

* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,807 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-17 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,556 | 🐛 507 | 🌐 TypeScript | 📅 2026-08-07 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,115 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,039 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-12 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-16 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [ember-apollo-client](https://github.com/ember-graphql/ember-apollo-client) ⭐ 280 | 🐛 27 | 🌐 JavaScript | 📅 2026-08-11 - An ember-cli addon for Apollo Client and GraphQL.

###### React

* [relay](https://github.com/facebook/relay) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-18 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,967 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-12 - A simple caching GraphQL client for React.
* [graphql-hooks](https://github.com/nearform/graphql-hooks) ⭐ 1,886 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-17 - Minimal hooks-first GraphQL client with caching and server-side rendering support.
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,039 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-12 - A No GraphQL client for TypeScript
* [mst-gql](https://github.com/mobxjs/mst-gql) ⭐ 690 | 🐛 89 | 🌐 JavaScript | 📅 2024-09-03 - Bindings for mobx-state-tree and GraphQL.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,944 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-17 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,528 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-14 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,483 | 🐛 68 | 🌐 JavaScript | 📅 2026-08-17 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 374 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-12 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 204 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 123 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-14 - Framework NodeJS for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,931 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-11 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 555 | 🌐 TypeScript | 📅 2026-08-17: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,967 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-15 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,608 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-07 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 102 | 🐛 8 | 🌐 TypeScript | 📅 2026-07-06 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,931 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-17, [Zod](https://github.com/colinhacks/zod) ⭐ 43,479 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-17, or [Yup](https://github.com/jquense/yup) ⭐ 23,673 | 🐛 250 | 🌐 TypeScript | 📅 2026-08-12.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-17 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,578 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-14 - A library that helps creating a permission layer for a graphql api.
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,536 | 🐛 11 | 🌐 Python | 📅 2026-08-18 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 182 | 🌐 TypeScript | 📅 2026-08-17 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,019 | 🐛 48 | 🌐 TypeScript | 📅 2026-06-02 - A command line tool for common GraphQL development workflows.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,250 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-18 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-08-14 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,145 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-01 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,118 | 🐛 39 | 🌐 TypeScript | 📅 2026-06-30 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 833 | 🐛 54 | 🌐 Go | 📅 2026-08-18 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 585 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-16 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-14 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 441 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-18 - Realtime GraphQL Live Queries with JavaScript.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,392 | 🐛 190 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,822 | 🐛 4,140 | 🌐 JavaScript | 📅 2026-08-18 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,667 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-16 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,409 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-12 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-14 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 65 | 🌐 Ruby | 📅 2026-08-17 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,716 | 🐛 60 | 🌐 PHP | 📅 2026-08-17 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,790 | 🐛 87 | 🌐 PHP | 📅 2026-08-17 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,502 | 🐛 137 | 🌐 PHP | 📅 2026-07-29 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,218 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 796 | 🐛 139 | 🌐 PHP | 📅 2026-04-13 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 575 | 🐛 32 | 🌐 MDX | 📅 2026-08-17 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,233 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,704 | 🐛 309 | 🌐 Python | 📅 2026-08-17 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,392 | 🐛 166 | 🌐 Python | 📅 2026-06-24 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,342 | 🐛 36 | 🌐 Python | 📅 2026-08-06 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [sgqlc](https://github.com/profusion/sgqlc) ⭐ 553 | 🐛 37 | 🌐 Python | 📅 2026-03-27 - Simple GraphQL Client makes working with GraphQL API responses easier in Python.
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 529 | 🐛 30 | 🌐 Python | 📅 2026-07-15 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [turms](https://github.com/jhnnsrs/turms) ⭐ 77 | 🐛 22 | 🌐 Python | 📅 2026-08-02 - A pythonic graphql codegenerator built around graphql-core and pydantic
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,221 | 🐛 40 | 🌐 Java | 📅 2026-08-14 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,383 | 🐛 49 | 🌐 Kotlin | 📅 2026-08-17 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,760 | 🐛 110 | 🌐 Java | 📅 2026-08-16 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 823 | 🐛 91 | 🌐 Kotlin | 📅 2026-08-16 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-17 for JS.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 19 | 🌐 Java | 📅 2026-08-17 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-18 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,778 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-04.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 7 | 🐛 3 | 🌐 Java | 📅 2026-08-07 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 288 | 🐛 6 | 🌐 Java | 📅 2026-08-10 - Extended scalars for graphql-java.
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 154 | 🐛 3 | 🌐 Java | 📅 2026-08-12 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 8 | 🌐 Java | 📅 2026-08-13 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 123 | 🐛 16 | 🌐 Java | 📅 2026-08-06 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,802 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-10 - GraphQL Kotlin implementation.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 350 | 🐛 14 | 🌐 C++ | 📅 2026-05-19 - C++ GraphQL schema service generator.
...
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,143 | 🐛 243 | 🌐 Go | 📅 2026-06-23 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,759 | 🐛 12 | 🌐 Go | 📅 2026-08-04 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,141 | 🐛 25 | 🌐 Go | 📅 2026-08-18: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 833 | 🐛 54 | 🌐 Go | 📅 2026-08-18 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 48 | 🐛 13 | 🌐 Go | 📅 2026-07-09 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,962 | 🐛 65 | 🌐 Scala | 📅 2026-08-17 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 27 | 🌐 Scala | 📅 2026-08-18 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [sangria-akka-http-example](https://github.com/sangria-graphql/sangria-akka-http-example) ⭐ 242 | 🐛 8 | 🌐 Scala | 📅 2025-10-25 - An example GraphQL server written with akka-http and [sangria](https://sangria-graphql.github.io/)
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,991 | 🐛 133 | 🌐 C# | 📅 2026-08-08 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,750 | 🐛 380 | 🌐 C# | 📅 2026-08-18 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 882 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 461 | 🐛 10 | 🌐 C# | 📅 2026-08-18 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 321 | 🐛 13 | 🌐 C# | 📅 2026-08-04 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,145 | 🐛 169 | 🌐 F# | 📅 2026-08-14
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,399 | 🐛 71 | 🌐 Elixir | 📅 2026-07-14 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,092 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-17 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,928 | 🐛 162 | 🌐 TypeScript | 📅 2026-08-17 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,969 | 🐛 115 | 🌐 Kotlin | 📅 2026-08-18 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,760 | 🐛 110 | 🌐 Java | 📅 2026-08-16 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,034 | 🐛 87 | 🌐 Swift | 📅 2026-07-21 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,269 | 🐛 164 | 🌐 Dart | 📅 2026-07-28 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,970 | 🐛 105 | 🌐 Rust | 📅 2026-07-27 - GraphQL server library for Rust.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,442 | 🐛 18 | 🌐 Rust | 📅 2026-08-18 - A platform for building high-performance GraphQL backends.
...
* [graphql-parser](https://github.com/graphql-rust/graphql-parser) ⭐ 374 | 🐛 24 | 🌐 Rust | 📅 2025-01-16 - A parser, formatter and AST for the GraphQL query and schema definition language for Rust.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 65 | 🌐 Ruby | 📅 2026-08-17 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 139 | 🐛 6 | 🌐 Ballerina | 📅 2026-08-06 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
...
* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 139 | 🐛 6 | 🌐 Ballerina | 📅 2026-08-06
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,391 | 🐛 1,793 | 🌐 JavaScript | 📅 2026-08-18 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,893 | 🐛 391 | 🌐 TypeScript | 📅 2026-08-11 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,158 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,064 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,425 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-16 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 142 | 🐛 9 | 🌐 Go | 📅 2026-07-28 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-08-18 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,798 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 685 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 169 | 🐛 13 | 🌐 Python | 📅 2026-08-07 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,528 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-16 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,230 | 🐛 99 | 🌐 JavaScript | 📅 2026-08-09 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-08-18 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
* [vim-graphql](https://github.com/jparise/vim-graphql) ⭐ 512 | 🐛 0 | 🌐 Vim Script | 📅 2026-07-25 - A Vim plugin that provides GraphQL file detection and syntax highlighting.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,567 | 🐛 2,543 | 🌐 TypeScript | 📅 2026-08-18 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-18 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,010 | 🐛 662 | 🌐 TypeScript | 📅 2026-06-30: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 555 | 🌐 TypeScript | 📅 2026-08-17 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,757 | 🐛 138 | 🌐 TypeScript | 📅 2026-06-17: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-14 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 116 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-11 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,656 | 🐛 1,110 | 🌐 Rust | 📅 2026-08-18
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,738 | 🐛 691 | 🌐 Go | 📅 2026-08-18 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,233 | 🐛 244 | 🌐 Python | 📅 2026-08-18 - GraphQL-first headless e-commerce platform.

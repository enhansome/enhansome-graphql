...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,585 | 🐛 196 | 🌐 JavaScript | 📅 2026-08-18 - Working draft of the specification for GraphQL.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,809 | 🐛 401 | 🌐 TypeScript | 📅 2026-08-22 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,956 | 🐛 871 | 🌐 Rust | 📅 2026-08-21 - Relay is a JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,946 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-22 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 556 | 🌐 TypeScript | 📅 2026-08-23: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 102 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-20 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,951 | 🐛 171 | 🌐 TypeScript | 📅 2026-08-22, [Zod](https://github.com/colinhacks/zod) ⭐ 43,513 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-20, or [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-21.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,551 | 🐛 8 | 🌐 Python | 📅 2026-08-23 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,887 | 🐛 3,961 | 🌐 JavaScript | 📅 2026-08-23 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,237 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,221 | 🐛 41 | 🌐 Java | 📅 2026-08-22 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,385 | 🐛 50 | 🌐 Kotlin | 📅 2026-08-17 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,146 | 🐛 25 | 🌐 Go | 📅 2026-08-23: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 53 | 🌐 Go | 📅 2026-08-21 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 27 | 🌐 Scala | 📅 2026-08-23 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,753 | 🐛 378 | 🌐 C# | 📅 2026-08-22 - GraphQL server for .Net Core and .NET Framework.
...
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,929 | 🐛 163 | 🌐 TypeScript | 📅 2026-08-17 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,442 | 🐛 18 | 🌐 Rust | 📅 2026-08-23 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,488 | 🐛 1,829 | 🌐 JavaScript | 📅 2026-08-21 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,898 | 🐛 394 | 🌐 TypeScript | 📅 2026-08-11 - An in-browser IDE for exploring GraphQL.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,556 | 🐛 2,552 | 🌐 TypeScript | 📅 2026-08-23 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,458 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-22 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 556 | 🌐 TypeScript | 📅 2026-08-23 - GraphQL code generator based on schema and documents.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,675 | 🐛 1,127 | 🌐 Rust | 📅 2026-08-23
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,748 | 🐛 695 | 🌐 Go | 📅 2026-08-22 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,258 | 🐛 248 | 🌐 Python | 📅 2026-08-21 - GraphQL-first headless e-commerce platform.

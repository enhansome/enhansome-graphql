...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,809 | 🐛 403 | 🌐 TypeScript | 📅 2026-08-20 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,556 | 🐛 509 | 🌐 TypeScript | 📅 2026-08-20 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,955 | 🐛 871 | 🌐 Rust | 📅 2026-08-21 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,966 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-20 - A simple caching GraphQL client for React.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 374 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-20 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 102 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-20 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,944 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-20, [Zod](https://github.com/colinhacks/zod) ⭐ 43,503 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-20, or [Yup](https://github.com/jquense/yup) ⭐ 23,674 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-12.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-21 - Tool library for building and maintaining GraphQL-JS servers.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,546 | 🐛 10 | 🌐 Python | 📅 2026-08-21 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,252 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-21 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,887 | 🐛 4,006 | 🌐 JavaScript | 📅 2026-08-21 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 66 | 🌐 Ruby | 📅 2026-08-20 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,219 | 🐛 0 | 🌐 PHP | 📅 2026-08-17 - Laravel wrapper for Facebook's GraphQL.
...
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,384 | 🐛 49 | 🌐 Kotlin | 📅 2026-08-17 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 8 | 🌐 Java | 📅 2026-08-20 - Examples of Light Java GraphQL and tutorials.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,802 | 🐛 85 | 🌐 Kotlin | 📅 2026-08-21 - GraphQL Kotlin implementation.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,144 | 🐛 25 | 🌐 Go | 📅 2026-08-20: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 53 | 🌐 Go | 📅 2026-08-21 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 27 | 🌐 Scala | 📅 2026-08-21 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,753 | 🐛 379 | 🌐 C# | 📅 2026-08-21 - GraphQL server for .Net Core and .NET Framework.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,098 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-08-19 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,970 | 🐛 111 | 🌐 Kotlin | 📅 2026-08-21 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,760 | 🐛 111 | 🌐 Java | 📅 2026-08-19 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,442 | 🐛 18 | 🌐 Rust | 📅 2026-08-21 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 66 | 🌐 Ruby | 📅 2026-08-20 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,443 | 🐛 1,825 | 🌐 JavaScript | 📅 2026-08-21 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,896 | 🐛 392 | 🌐 TypeScript | 📅 2026-08-11 - An in-browser IDE for exploring GraphQL.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,573 | 🐛 2,544 | 🌐 TypeScript | 📅 2026-08-21 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,456 | 🐛 90 | 🌐 TypeScript | 📅 2026-08-21 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,007 | 🐛 661 | 🌐 TypeScript | 📅 2026-06-30: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,673 | 🐛 1,118 | 🌐 Rust | 📅 2026-08-21
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,745 | 🐛 691 | 🌐 Go | 📅 2026-08-21 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,247 | 🐛 249 | 🌐 Python | 📅 2026-08-21 - GraphQL-first headless e-commerce platform.

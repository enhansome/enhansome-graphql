...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,588 | 🐛 196 | 🌐 JavaScript | 📅 2026-09-04 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 427 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-03 - Working draft of "GraphQL over HTTP" specification.
* [OpenCRUD](https://github.com/opencrud/opencrud) ⭐ 390 | 🐛 35 | 📅 2022-07-21 - OpenCRUD is a GraphQL CRUD API specification for databases.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,693 | 🐛 3 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,343 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-04 - A reference implementation of GraphQL for JavaScript.
* [graphql-jit](https://github.com/zalando-incubator/graphql-jit) ⭐ 1,084 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-02 - GraphQL execution using a JIT compiler.
* [Gra*fast*](https://grafast.org) - a cutting edge planning and execution engine for GraphQL.

#### Clients

* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,813 | 🐛 404 | 🌐 TypeScript | 📅 2026-09-05 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,559 | 🐛 512 | 🌐 TypeScript | 📅 2026-09-04 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,118 | 🐛 59 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
* [graphqurl](https://github.com/hasura/graphqurl) ⭐ 3,377 | 🐛 43 | 🌐 JavaScript | 📅 2025-02-13 - curl for GraphQL with autocomplete, subscriptions and GraphiQL. Also a dead-simple universal javascript GraphQL client.
* [graphql-zeus](https://github.com/graphql-editor/graphql-zeus) ⭐ 1,977 | 🐛 60 | 🌐 TypeScript | 📅 2026-04-07 - GraphQL Zeus creates autocomplete client library for `JavaScript` or `TypeScript` which provides autocompletion for strongly typed queries.
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,038 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-03 - A No GraphQL client for TypeScript
* [genql](https://github.com/remorses/genql) ⭐ 977 | 🐛 10 | 🌐 TypeScript | 📅 2026-06-11 - Type safe TypeScript client for any GraphQL API.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,032 | 🐛 276 | 🌐 TypeScript | 📅 2026-08-06 - Apollo/GraphQL integration for VueJS.
...
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 947 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-03 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 423 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-03 - GraphQL web components that work in any frontend framework.
* [ember-apollo-client](https://github.com/ember-graphql/ember-apollo-client) ⭐ 280 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-03 - An ember-cli addon for Apollo Client and GraphQL.

###### React

* [relay](https://github.com/facebook/relay) ⭐ 18,963 | 🐛 862 | 🌐 Rust | 📅 2026-09-04 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,972 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-22 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,038 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-03 - A No GraphQL client for TypeScript
* [mst-gql](https://github.com/mobxjs/mst-gql) ⭐ 691 | 🐛 89 | 🌐 JavaScript | 📅 2024-09-03 - Bindings for mobx-state-tree and GraphQL.
* [micro-graphql-react](https://github.com/arackaf/micro-graphql-react) ⭐ 525 | 🐛 22 | 🌐 JavaScript | 📅 2024-06-22 - A lightweight utility for adding GraphQL to React. components. Includes simple caching and uses GET requests that could additionally be cached through a service-worker.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,951 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-05 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,528 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-20 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,487 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-31 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 375 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-04 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 204 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 123 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-04 - Framework NodeJS for GraphQL.
...
* [graphql-sequelize](https://github.com/mickhansen/graphql-sequelize) ⭐ 1,884 | 🐛 1 | 🌐 JavaScript | 📅 2022-11-16 - Sequelize helpers for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,930 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-20 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,265 | 🐛 558 | 🌐 TypeScript | 📅 2026-09-04: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,092 | 🐛 120 | 🌐 TypeScript | 📅 2026-07-16 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,972 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-22 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,614 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-05 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 103 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-02 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,974 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-05, [Zod](https://github.com/colinhacks/zod) ⭐ 43,843 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-04, or [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 252 | 🌐 TypeScript | 📅 2026-09-05.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,433 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-05 - Tool library for building and maintaining GraphQL-JS servers.
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,581 | 🐛 12 | 🌐 Python | 📅 2026-09-04 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,579 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-03 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-04 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,019 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-03 - A command line tool for common GraphQL development workflows.
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,871 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-06 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
* [graphql-relay-js](https://github.com/graphql/graphql-relay-js) ⭐ 1,541 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-03 - A library to help construct a graphql-js server supporting react-relay.
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,327 | 🐛 52 | 🌐 TypeScript | 📅 2026-07-12 - Separate GraphQL server into smaller, reusable parts by modules or features.
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,263 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-05 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-04 - An ESLint plugin that checks your GraphQL strings against a schema.
* [graphql-compose](https://github.com/graphql-compose/graphql-compose) ⭐ 1,209 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-01 - Tool which allows you to construct flexible graphql schema from different data sources via plugins.
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,197 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-25 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,146 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-04 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,119 | 🐛 39 | 🌐 TypeScript | 📅 2026-06-30 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 59 | 🌐 Go | 📅 2026-09-04 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 587 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-04 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
* [graphql-let](https://github.com/piglovesyou/graphql-let) ⭐ 452 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-11 - A webpack loader to import type-protected codegen results directly from GraphQL documents
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 441 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-04 - Realtime GraphQL Live Queries with JavaScript.
...
* [goctopus](https://github.com/Escape-Technologies/goctopus) ⭐ 134 | 🐛 3 | 🌐 Go | 📅 2023-11-21 - an incredibly fast GraphQL discovery & fingerprinting toolbox.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,394 | 🐛 191 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 142,100 | 🐛 3,282 | 🌐 JavaScript | 📅 2026-09-05 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,673 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-31 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,410 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-03 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-09-02 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,441 | 🐛 16 | 🌐 Ruby | 📅 2026-07-27 - A query batching executor for the graphql gem.
* [agoo](https://github.com/ohler55/agoo) ⭐ 933 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Ruby web server that implements Facebook's GraphQL.
...
* [agoo-demo](https://github.com/ohler55/agoo/tree/develop/example/graphql) ⭐ 933 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Use of the Agoo server to demonstrate a simple GraphQL application.
* [rails-devise-graphql](https://github.com/zauberware/rails-devise-graphql) ⭐ 284 | 🐛 12 | 🌐 Ruby | 📅 2023-01-19 - A rails 6 boilerplate with devise, graphql & JWT auth.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,717 | 🐛 66 | 🌐 PHP | 📅 2026-09-03 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,791 | 🐛 80 | 🌐 PHP | 📅 2026-09-04 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,500 | 🐛 137 | 🌐 PHP | 📅 2026-09-02 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,221 | 🐛 1 | 🌐 PHP | 📅 2026-08-17 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 795 | 🐛 140 | 🌐 PHP | 📅 2026-04-13 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 576 | 🐛 25 | 🌐 MDX | 📅 2026-09-01 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,239 | 🐛 113 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,712 | 🐛 303 | 🌐 Python | 📅 2026-09-05 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,394 | 🐛 164 | 🌐 Python | 📅 2026-06-24 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,343 | 🐛 34 | 🌐 Python | 📅 2026-08-31 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 531 | 🐛 30 | 🌐 Python | 📅 2026-09-03 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
* [django-graphql-auth](https://github.com/PedroBern/django-graphql-auth) ⭐ 331 | 🐛 72 | 🌐 Python | 📅 2024-08-06 - Django registration and authentication with GraphQL.
...
* [turms](https://github.com/jhnnsrs/turms) ⭐ 76 | 🐛 24 | 🌐 Python | 📅 2026-09-01 - A pythonic graphql codegenerator built around graphql-core and pydantic
...
* [rath](https://github.com/jhnnsrs/rath) ⭐ 11 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - An apollo like graphql client with async and sync interface
...
* [tartiflette](https://github.com/dailymotion/tartiflette) ⭐ 0 | 🐛 1 | 📅 2026-08-04 - GraphQL Implementation, SDL First, for python 3.6+ / asyncio.
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,221 | 🐛 42 | 🌐 Java | 📅 2026-09-01 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,389 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-31 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,761 | 🐛 111 | 🌐 Java | 📅 2026-09-05 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 823 | 🐛 92 | 🌐 Kotlin | 📅 2026-09-04 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,433 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-05 for JS.
* [graphql-java-annotations](https://github.com/Enigmatis/graphql-java-annotations) ⭐ 393 | 🐛 4 | 🌐 Java | 📅 2026-09-03 - Provides annotations-based syntax for schema definition with GraphQL Java.
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 21 | 🌐 Java | 📅 2026-09-04 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 229 | 🐛 24 | 🌐 Java | 📅 2026-09-05 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 37 | 🐛 10 | 🌐 Java | 📅 2026-08-13: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,785 | 🐛 3,444 | 🌐 Mustache | 📅 2026-08-18.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 7 | 🐛 3 | 🌐 Java | 📅 2026-09-01 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 290 | 🐛 7 | 🌐 Java | 📅 2026-08-31 - Extended scalars for graphql-java.
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 154 | 🐛 5 | 🌐 Java | 📅 2026-08-24 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 8 | 🌐 Java | 📅 2026-08-22 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 123 | 🐛 16 | 🌐 Java | 📅 2026-08-26 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,803 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-31 - GraphQL Kotlin implementation.
...
* [Graphkt](https://github.com/cufyorg/graphkt) ⭐ 10 | 🐛 1 | 🌐 Kotlin | 📅 2024-04-14 - A DSL based graphql server library for kotlin, backed by graphql-java.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 353 | 🐛 15 | 🌐 C++ | 📅 2026-05-19 - C++ GraphQL schema service generator.
* [agoo-c](https://github.com/ohler55/agoo-c) ⭐ 153 | 🐛 3 | 🌐 C | 📅 2020-12-16 - A high performance GraphQL server written in C. [benchmarks](https://github.com/the-benchmarker/graphql-benchmarks) ⭐ 56 | 🐛 2 | 🌐 Ruby | 📅 2021-08-19
...
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,144 | 🐛 247 | 🌐 Go | 📅 2026-06-23 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,761 | 🐛 9 | 🌐 Go | 📅 2026-09-03 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,158 | 🐛 21 | 🌐 Go | 📅 2026-09-03: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 59 | 🌐 Go | 📅 2026-09-04 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [grpc-graphql-gateway](https://github.com/ysugimoto/grpc-graphql-gateway) ⭐ 426 | 🐛 17 | 🌐 Go | 📅 2025-06-04 - A protoc plugin that generates graphql execution code from Protocol Buffers.
  <a name="go-example" />
...
* [Thunder](https://github.com/Raezil/Thunder) ⭐ 122 | 🐛 0 | 🌐 Go | 📅 2025-12-05 - A scalable microservices framework powered by Go, gRPC-Gateway, Prisma, and Kubernetes. It exposes REST, gRPC and Graphql
* [gql](https://github.com/kadirpekel/gql) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2026-05-11 - Code first graphql (graphql-go/graphql) schema builder.
...
* [todomvc-relay-go](https://github.com/sogko/todomvc-relay-go) ⭐ 65 | 🐛 3 | 🌐 JavaScript | 📅 2016-08-03 - Port of the React/Relay TodoMVC app, driven by a Golang GraphQL backend.
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 48 | 🐛 14 | 🌐 Go | 📅 2026-07-09 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,961 | 🐛 67 | 🌐 Scala | 📅 2026-08-30 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 28 | 🌐 Scala | 📅 2026-09-05 - Caliban is a purely functional library for creating GraphQL backends in Scala.
* [sangria-relay](https://github.com/sangria-graphql/sangria-relay) ⭐ 91 | 🐛 15 | 🌐 Scala | 📅 2026-06-07 - Sangria Relay Support.

<a name="scala-example" />

#### Scala Examples

* [sangria-akka-http-example](https://github.com/sangria-graphql/sangria-akka-http-example) ⭐ 241 | 🐛 8 | 🌐 Scala | 📅 2025-10-25 - An example GraphQL server written with akka-http and [sangria](https://sangria-graphql.github.io/)
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,990 | 🐛 139 | 🌐 C# | 📅 2026-09-03 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,753 | 🐛 375 | 🌐 C# | 📅 2026-09-04 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 882 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 462 | 🐛 10 | 🌐 C# | 📅 2026-09-03 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 323 | 🐛 13 | 🌐 C# | 📅 2026-08-04 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,149 | 🐛 160 | 🌐 F# | 📅 2026-09-03
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,401 | 🐛 68 | 🌐 Elixir | 📅 2026-09-02 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 24 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⚠️ Archived
...
* [morpheus-graphql](https://github.com/morpheusgraphql/morpheus-graphql) ⭐ 415 | 🐛 19 | 🌐 Haskell | 📅 2026-06-15 - Haskell GraphQL Api, Client and Tools.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,112 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,932 | 🐛 163 | 🌐 TypeScript | 📅 2026-09-04 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [Lacinia](https://github.com/walmartlabs/lacinia) ⭐ 1,862 | 🐛 10 | 🌐 Clojure | 📅 2026-06-03 - GraphQL implementation in pure Clojure.
...
* [Clojure Game Geek](https://github.com/walmartlabs/clojure-game-geek) ⭐ 47 | 🐛 1 | 🌐 Clojure | 📅 2023-01-17 - Example code for the Lacinia GraphQL framework tutorial.

<a name="swift" />

### Swift

* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 962 | 🐛 7 | 🌐 Swift | 📅 2026-07-08 - The Swift implementation for GraphQL.

<a name="ocaml" />

### OCaml

* [ocaml-graphql-server](https://github.com/andreas/ocaml-graphql-server) ⭐ 618 | 🐛 28 | 🌐 OCaml | 📅 2024-03-03 - GraphQL servers in OCaml.

<a name="android" />

### Android

* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,973 | 🐛 109 | 🌐 Kotlin | 📅 2026-09-04 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,761 | 🐛 111 | 🌐 Java | 📅 2026-09-05 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,035 | 🐛 88 | 🌐 Swift | 📅 2026-08-20 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [re-graph](https://github.com/oliyh/re-graph) ⭐ 466 | 🐛 14 | 🌐 Clojure | 📅 2026-06-24 - A GraphQL client for ClojureScript with bindings for re-frame applications.
* [graphql-query](https://github.com/district0x/graphql-query) ⭐ 74 | 🐛 6 | 🌐 Clojure | 📅 2024-03-14 - Clojure(Script) GraphQL query generation.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,271 | 🐛 164 | 🌐 Dart | 📅 2026-07-28 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,969 | 🐛 104 | 🌐 Rust | 📅 2026-09-03 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,680 | 🐛 252 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [graphql-client](https://github.com/tomhoule/graphql-client) ⭐ 1,263 | 🐛 113 | 🌐 Rust | 📅 2026-08-11 - GraphQL client library for Rust with WebAssembly (wasm) support.
* [graphql-parser](https://github.com/graphql-rust/graphql-parser) ⭐ 370 | 🐛 24 | 🌐 Rust | 📅 2025-01-16 - A parser, formatter and AST for the GraphQL query and schema definition language for Rust.
...
* [graphqld](https://github.com/burner/graphqld) ⭐ 36 | 🐛 6 | 🌐 D | 📅 2026-02-26 - GraphQL server library for D.

<a name="r" />

### R (Rstat)

* [ghql](https://github.com/ropensci/ghql) ⭐ 150 | 🐛 5 | 🌐 R | 📅 2026-02-18 - General purpose GraphQL R client.
* [gqlr](https://github.com/schloerke/gqlr) ⭐ 61 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-12 - R GraphQL Implementation.
...
* [Diana.jl](https://github.com/codeneomatrix/Diana.jl) ⭐ 114 | 🐛 6 | 🌐 Julia | 📅 2022-08-16 - A Julia GraphQL client/server implementation.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-09-02 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
* [graphql](https://github.com/graphql-crystal/graphql) ⭐ 139 | 🐛 9 | 🌐 Crystal | 📅 2026-08-08 - GraphQL server library.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 139 | 🐛 2 | 🌐 Ballerina | 📅 2026-09-04 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
* [graphql CLI](https://github.com/ballerina-platform/graphql-tools) ⭐ 108 | 🐛 5 | 🌐 Java | 📅 2026-07-19 - A CLI tool to generate Ballerina code from GraphQL schema and GraphQL schema from Ballerina code. It also provides functionality to generate usage-specific GraphQL clients using GraphQL schemas and documents.

#### Ballerina Samples

* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 139 | 🐛 2 | 🌐 Ballerina | 📅 2026-09-04
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,765 | 🐛 1,828 | 🌐 JavaScript | 📅 2026-09-05 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,902 | 🐛 386 | 🌐 TypeScript | 📅 2026-09-04 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,164 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,066 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,431 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-16 - A beautiful feature-rich GraphQL Client for all platforms.
* [GraphQL Birdseye](https://github.com/Novvum/graphql-birdseye) ⭐ 699 | 🐛 30 | 🌐 TypeScript | 📅 2022-12-10 – View any GraphQL schema as a dynamic and interactive graph.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 144 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-09-05 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,805 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 688 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 170 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,528 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-05 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,229 | 🐛 98 | 🌐 JavaScript | 📅 2026-08-09 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-09-04 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
* [vim-graphql](https://github.com/jparise/vim-graphql) ⭐ 512 | 🐛 0 | 🌐 Vim Script | 📅 2026-08-23 - A Vim plugin that provides GraphQL file detection and syntax highlighting.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,601 | 🐛 2,589 | 🌐 TypeScript | 📅 2026-09-02 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,472 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-05 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,011 | 🐛 661 | 🌐 TypeScript | 📅 2026-06-30: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,265 | 🐛 558 | 🌐 TypeScript | 📅 2026-09-04 - GraphQL code generator based on schema and documents.
* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,949 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-02 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,764 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [tuql](https://github.com/bradleyboy/tuql) ⭐ 1,076 | 🐛 15 | 🌐 JavaScript | 📅 2021-06-06 - Automatically create a GraphQL server from any sqlite database.
* [swagger-to-graphql](https://github.com/yarax/swagger-to-graphql) ⭐ 921 | 🐛 39 | 🌐 TypeScript | 📅 2023-03-01 - GraphQL types builder based on REST API described in Swagger. Allows to migrate to GraphQL from REST for 5 minutes
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-04 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 117 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-02 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [gqlhash](https://github.com/romshark/gqlhash) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2026-08-06 - Lightning fast query hasher that ignores formatting diffs and comments and supports multiple hashing functions.
* [Apollo APQ Debugger](https://github.com/rookieInTraining/apq-debugger) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2026-06-13 - Reveal full GraphQL queries behind Apollo APQ hashes. Inspect fallback flow and debug Automatic Persisted Queries in DevTools. <a name="databases" />
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,777 | 🐛 1,159 | 🌐 Rust | 📅 2026-09-05
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,785 | 🐛 712 | 🌐 Go | 📅 2026-09-05 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,291 | 🐛 249 | 🌐 Python | 📅 2026-09-04 - GraphQL-first headless e-commerce platform.

* [Unchained Engine](https://github.com/unchainedshop/unchained) ⭐ 201 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-03 - GraphQL-first open-source headless e-commerce framework for Node.js.

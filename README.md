...
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 427 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-14 - Working draft of "GraphQL over HTTP" specification.
...
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,557 | 🐛 508 | 🌐 TypeScript | 📅 2026-08-27 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,116 | 🐛 59 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,528 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-20 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 375 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-26 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,091 | 🐛 119 | 🌐 TypeScript | 📅 2026-07-16 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 102 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-24 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,963 | 🐛 174 | 🌐 TypeScript | 📅 2026-08-22, [Zod](https://github.com/colinhacks/zod) ⭐ 43,538 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-27, or [Yup](https://github.com/jquense/yup) ⭐ 23,671 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-26.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,564 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,256 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-27 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,957 | 🐛 3,658 | 🌐 JavaScript | 📅 2026-08-27 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,668 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-23 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-08-26 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,444 | 🐛 62 | 🌐 Ruby | 📅 2026-08-27 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,791 | 🐛 85 | 🌐 PHP | 📅 2026-08-26 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,501 | 🐛 137 | 🌐 PHP | 📅 2026-07-29 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,707 | 🐛 309 | 🌐 Python | 📅 2026-08-26 - A new GraphQL library for Python.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 21 | 🌐 Java | 📅 2026-08-26 - Apollo Federation on the JVM.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,780 | 🐛 3,447 | 🌐 Mustache | 📅 2026-08-18.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 27 | 🌐 Scala | 📅 2026-08-27 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,752 | 🐛 379 | 🌐 C# | 📅 2026-08-27 - GraphQL server for .Net Core and .NET Framework.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,444 | 🐛 62 | 🌐 Ruby | 📅 2026-08-27 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,581 | 🐛 1,825 | 🌐 JavaScript | 📅 2026-08-27 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,899 | 🐛 393 | 🌐 TypeScript | 📅 2026-08-26 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,160 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
...
* [Bit](https://github.com/teambit/bit) ⭐ 18,463 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-26 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,716 | 🐛 1,137 | 🌐 Rust | 📅 2026-08-27
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,754 | 🐛 692 | 🌐 Go | 📅 2026-08-27 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,267 | 🐛 246 | 🌐 Python | 📅 2026-08-27 - GraphQL-first headless e-commerce platform.

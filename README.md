...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,801 | 🐛 409 | 🌐 TypeScript | 📅 2026-09-10 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,560 | 🐛 511 | 🌐 TypeScript | 📅 2026-09-09 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,038 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-10 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-09 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,961 | 🐛 860 | 🌐 Rust | 📅 2026-09-09 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,038 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-10 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,950 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-10 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 123 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-09 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,262 | 🐛 559 | 🌐 TypeScript | 📅 2026-09-09: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,972 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-09 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,615 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-10 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 104 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-07 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,981 | 🐛 177 | 🌐 TypeScript | 📅 2026-09-10, [Zod](https://github.com/colinhacks/zod) ⭐ 43,921 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-09, or [Yup](https://github.com/jquense/yup) ⭐ 23,665 | 🐛 253 | 🌐 TypeScript | 📅 2026-09-09.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,594 | 🐛 11 | 🌐 Python | 📅 2026-09-10 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,577 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-09 - A library that helps creating a permission layer for a graphql api.
...
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,871 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-06 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,263 | 🐛 120 | 🌐 TypeScript | 📅 2026-09-10 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-09 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 835 | 🐛 55 | 🌐 Go | 📅 2026-09-09 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 441 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-09 - Realtime GraphQL Live Queries with JavaScript.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 142,217 | 🐛 3,333 | 🌐 JavaScript | 📅 2026-09-10 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,674 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-09 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-09-10 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,791 | 🐛 79 | 🌐 PHP | 📅 2026-09-09 - GraphQL API for WordPress.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,714 | 🐛 306 | 🌐 Python | 📅 2026-09-09 - A new GraphQL library for Python.
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 229 | 🐛 24 | 🌐 Java | 📅 2026-09-10 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,162 | 🐛 22 | 🌐 Go | 📅 2026-09-09: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 835 | 🐛 55 | 🌐 Go | 📅 2026-09-09 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,991 | 🐛 144 | 🌐 C# | 📅 2026-09-10 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,755 | 🐛 373 | 🌐 C# | 📅 2026-09-10 - GraphQL server for .Net Core and .NET Framework.
...
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,929 | 🐛 164 | 🌐 TypeScript | 📅 2026-09-09 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,974 | 🐛 110 | 🌐 Kotlin | 📅 2026-09-09 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,763 | 🐛 111 | 🌐 Java | 📅 2026-09-10 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,443 | 🐛 63 | 🌐 Ruby | 📅 2026-09-10 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 139 | 🐛 4 | 🌐 Ballerina | 📅 2026-09-10 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
* [graphql CLI](https://github.com/ballerina-platform/graphql-tools) ⭐ 108 | 🐛 2 | 🌐 Java | 📅 2026-09-10 - A CLI tool to generate Ballerina code from GraphQL schema and GraphQL schema from Ballerina code. It also provides functionality to generate usage-specific GraphQL clients using GraphQL schemas and documents.

#### Ballerina Samples

* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 139 | 🐛 4 | 🌐 Ballerina | 📅 2026-09-10
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,870 | 🐛 1,827 | 🌐 JavaScript | 📅 2026-09-10 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,903 | 🐛 391 | 🌐 TypeScript | 📅 2026-09-09 - An in-browser IDE for exploring GraphQL.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-09-10 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,808 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-09 - A Burp Extension for GraphQL Security Testing
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,598 | 🐛 2,606 | 🌐 TypeScript | 📅 2026-09-10 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,474 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-10 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,262 | 🐛 559 | 🌐 TypeScript | 📅 2026-09-09 - GraphQL code generator based on schema and documents.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,799 | 🐛 1,186 | 🌐 Rust | 📅 2026-09-10
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,799 | 🐛 735 | 🌐 Go | 📅 2026-09-10 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,314 | 🐛 262 | 🌐 Python | 📅 2026-09-10 - GraphQL-first headless e-commerce platform.

...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,343 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-04 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,812 | 🐛 403 | 🌐 TypeScript | 📅 2026-09-03 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,560 | 🐛 514 | 🌐 TypeScript | 📅 2026-09-03 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,964 | 🐛 862 | 🌐 Rust | 📅 2026-09-03 - Relay is a JavaScript framework for building data-driven React applications.
...
* [pothos](https://github.com/hayes/pothos) ⭐ 2,613 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-03 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 103 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-02 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,975 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-03, [Zod](https://github.com/colinhacks/zod) ⭐ 43,826 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-04, or [Yup](https://github.com/jquense/yup) ⭐ 23,672 | 🐛 252 | 🌐 TypeScript | 📅 2026-09-03.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,433 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-04 - Tool library for building and maintaining GraphQL-JS servers.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,579 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 176 | 🌐 TypeScript | 📅 2026-09-04 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,262 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-04 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 58 | 🌐 Go | 📅 2026-09-04 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 587 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-03 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-04 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 142,090 | 🐛 3,272 | 🌐 JavaScript | 📅 2026-09-04 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,791 | 🐛 77 | 🌐 PHP | 📅 2026-09-03 - GraphQL API for WordPress.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,712 | 🐛 307 | 🌐 Python | 📅 2026-09-03 - A new GraphQL library for Python.
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 229 | 🐛 24 | 🌐 Java | 📅 2026-09-04 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,753 | 🐛 376 | 🌐 C# | 📅 2026-09-04 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,148 | 🐛 160 | 🌐 F# | 📅 2026-09-03
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,108 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,932 | 🐛 164 | 🌐 TypeScript | 📅 2026-09-02 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,681 | 🐛 252 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,755 | 🐛 1,828 | 🌐 JavaScript | 📅 2026-09-04 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,901 | 🐛 386 | 🌐 TypeScript | 📅 2026-09-03 - An in-browser IDE for exploring GraphQL.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-09-04 - **Generate Karate API tests** from your GraphQL schemas
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,528 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-03 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,598 | 🐛 2,587 | 🌐 TypeScript | 📅 2026-09-02 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,472 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-03 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,776 | 🐛 1,156 | 🌐 Rust | 📅 2026-09-04
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,785 | 🐛 716 | 🌐 Go | 📅 2026-09-04 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,289 | 🐛 248 | 🌐 Python | 📅 2026-09-03 - GraphQL-first headless e-commerce platform.

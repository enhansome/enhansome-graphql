...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,591 | 🐛 197 | 🌐 JavaScript | 📅 2026-09-10 - Working draft of the specification for GraphQL.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,342 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-09 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,800 | 🐛 411 | 🌐 TypeScript | 📅 2026-09-17 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,561 | 🐛 512 | 🌐 TypeScript | 📅 2026-09-17 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,963 | 🐛 861 | 🌐 Rust | 📅 2026-09-17 - JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,952 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-16 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,529 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-17 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,262 | 🐛 556 | 🌐 TypeScript | 📅 2026-09-17 - GraphQL code generator with flexible support for custom plugins and templates such as TypeScript, React Hooks, and resolver signatures.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,431 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-16 - Tool library for building and maintaining GraphQL-JS servers.
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,605 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,576 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-15 - Library for creating a permission layer for a GraphQL API.
...
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,871 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-16 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,265 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-17 - Open source GraphQL federation solution with schema registry, composition checks, analytics, metrics, tracing, and routing.
...
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,146 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-16 - Split up your GraphQL resolvers in middleware functions.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 142,347 | 🐛 3,407 | 🌐 JavaScript | 📅 2026-09-17 - Type-protected GraphQL example on Next.js running graphql-codegen under the hood.
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,681 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-14 - Frontend starter kit using React, Relay, GraphQL, and JAMstack architecture.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 63 | 🌐 Ruby | 📅 2026-09-16 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,789 | 🐛 104 | 🌐 PHP | 📅 2026-09-16 - GraphQL API for WordPress.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,716 | 🐛 305 | 🌐 Python | 📅 2026-09-16 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,342 | 🐛 34 | 🌐 Python | 📅 2026-08-31 - Library for implementing GraphQL servers using a schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular web frameworks with comprehensive documentation.
...
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 824 | 🐛 93 | 🌐 Kotlin | 📅 2026-09-16 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers, inspired by graphql-tools for JS.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-09-16 - Apollo Federation on the JVM.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,803 | 🐛 84 | 🌐 Kotlin | 📅 2026-08-31 - GraphQL Kotlin implementation.
...
* [GraphQL](https://github.com/graphql-go/graphql) ⭐ 10,143 | 🐛 247 | 🌐 Go | 📅 2026-06-23 - Implementation of GraphQL for Go that follows graphql-js.
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,760 | 🐛 9 | 🌐 Go | 📅 2026-09-03 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,171 | 🐛 23 | 🌐 Go | 📅 2026-09-15 - Instant GraphQL-to-SQL compiler for building APIs quickly.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 57 | 🌐 Go | 📅 2026-09-17 - GraphQL router and API gateway framework written in Go, focused on correctness, extensibility, and performance.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,960 | 🐛 71 | 🌐 Scala | 📅 2026-09-17 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 996 | 🐛 27 | 🌐 Scala | 📅 2026-09-17 - Purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,990 | 🐛 134 | 🌐 C# | 📅 2026-09-11 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,756 | 🐛 377 | 🌐 C# | 📅 2026-09-17 - GraphQL server for .Net Core and .NET Framework.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,112 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-09 - Provides instant real-time GraphQL APIs over new or existing PostgreSQL databases.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,931 | 🐛 169 | 🌐 TypeScript | 📅 2026-09-17 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,973 | 🐛 109 | 🌐 Kotlin | 📅 2026-09-16 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
...
* [GraphQL CLI](https://github.com/ballerina-platform/graphql-tools) ⭐ 107 | 🐛 2 | 🌐 Java | 📅 2026-09-17 - A CLI tool to generate Ballerina code from GraphQL schema and GraphQL schema from Ballerina code. It also provides functionality to generate usage-specific GraphQL clients using GraphQL schemas and documents.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 47,014 | 🐛 1,848 | 🌐 JavaScript | 📅 2026-09-17 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,908 | 🐛 388 | 🌐 TypeScript | 📅 2026-09-15 - An in-browser IDE for exploring GraphQL.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-09-17 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,614 | 🐛 2,633 | 🌐 TypeScript | 📅 2026-09-17 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,484 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-16 - Organize GraphQL API components for reuse across projects.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,767 | 🐛 140 | 🌐 TypeScript | 📅 2026-09-09 - Validate schemas and operations, get schema change notifications, find breaking changes and similar types, and measure schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-16 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://github.com/cube-js/cube.js) ⭐ 20,864 | 🐛 1,184 | 🌐 Rust | 📅 2026-09-17 - Headless BI platform for building data applications with GraphQL, SQL, and REST APIs with sub-second latency.
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,816 | 🐛 746 | 🌐 Go | 📅 2026-09-17 - Cloud-native, modular, real-time vector search engine with a GraphQL interface that scales machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,339 | 🐛 273 | 🌐 Python | 📅 2026-09-17 - GraphQL-first headless e-commerce platform.

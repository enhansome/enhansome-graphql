...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,584 | 🐛 196 | 🌐 JavaScript | 📅 2026-08-18 - Working draft of the specification for GraphQL.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,809 | 🐛 400 | 🌐 TypeScript | 📅 2026-08-21 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,556 | 🐛 510 | 🌐 TypeScript | 📅 2026-08-21 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,114 | 🐛 60 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-20 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,956 | 🐛 870 | 🌐 Rust | 📅 2026-08-21 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,966 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-22 - A simple caching GraphQL client for React.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,945 | 🐛 88 | 🌐 TypeScript | 📅 2026-08-17 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,526 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-20 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,483 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-22 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 374 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-21 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 204 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 123 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-21 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 555 | 🌐 TypeScript | 📅 2026-08-22: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,966 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-22 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,608 | 🐛 67 | 🌐 TypeScript | 📅 2026-08-21 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 102 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-20 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,946 | 🐛 170 | 🌐 TypeScript | 📅 2026-08-22, [Zod](https://github.com/colinhacks/zod) ⭐ 43,508 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-20, or [Yup](https://github.com/jquense/yup) ⭐ 23,673 | 🐛 251 | 🌐 TypeScript | 📅 2026-08-21.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-21 - Tool library for building and maintaining GraphQL-JS servers.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,551 | 🐛 8 | 🌐 Python | 📅 2026-08-22 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,512 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-20 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,253 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-21 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-08-21 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 53 | 🌐 Go | 📅 2026-08-21 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 586 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-20 - An instant security layer for production GraphQL Endpoints.
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 441 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-22 - Realtime GraphQL Live Queries with JavaScript.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 141,885 | 🐛 3,958 | 🌐 JavaScript | 📅 2026-08-22 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,444 | 🐛 64 | 🌐 Ruby | 📅 2026-08-21 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,719 | 🐛 60 | 🌐 PHP | 📅 2026-08-19 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,790 | 🐛 80 | 🌐 PHP | 📅 2026-08-22 - GraphQL API for WordPress.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,235 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,704 | 🐛 308 | 🌐 Python | 📅 2026-08-19 - A new GraphQL library for Python.
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,221 | 🐛 52 | 🌐 Java | 📅 2026-08-20 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,385 | 🐛 49 | 🌐 Kotlin | 📅 2026-08-17 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 19 | 🌐 Java | 📅 2026-08-20 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 228 | 🐛 24 | 🌐 Java | 📅 2026-08-22 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 7 | 🐛 3 | 🌐 Java | 📅 2026-08-21 - An experimental set of DGS Directives for common formatting use-cases.
...
* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 8 | 🌐 Java | 📅 2026-08-21 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 123 | 🐛 16 | 🌐 Java | 📅 2026-08-20 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,802 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-21 - GraphQL Kotlin implementation.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 352 | 🐛 15 | 🌐 C++ | 📅 2026-05-19 - C++ GraphQL schema service generator.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,751 | 🐛 386 | 🌐 Go | 📅 2026-08-19 - Go generate based graphql server library.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,146 | 🐛 25 | 🌐 Go | 📅 2026-08-22: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 834 | 🐛 53 | 🌐 Go | 📅 2026-08-21 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,962 | 🐛 69 | 🌐 Scala | 📅 2026-08-20 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 27 | 🌐 Scala | 📅 2026-08-22 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,753 | 🐛 380 | 🌐 C# | 📅 2026-08-22 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,144 | 🐛 169 | 🌐 F# | 📅 2026-08-19
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,972 | 🐛 108 | 🌐 Kotlin | 📅 2026-08-21 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,760 | 🐛 111 | 🌐 Java | 📅 2026-08-19 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,442 | 🐛 18 | 🌐 Rust | 📅 2026-08-22 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,444 | 🐛 64 | 🌐 Ruby | 📅 2026-08-21 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 245 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 219 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 46,465 | 🐛 1,826 | 🌐 JavaScript | 📅 2026-08-21 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,896 | 🐛 393 | 🌐 TypeScript | 📅 2026-08-11 - An in-browser IDE for exploring GraphQL.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 143 | 🐛 10 | 🌐 Go | 📅 2026-08-18 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 17 | 🐛 3 | 🌐 C# | 📅 2026-08-21 - **Generate Karate API tests** from your GraphQL schemas
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-08-21 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 47,556 | 🐛 2,550 | 🌐 TypeScript | 📅 2026-08-22 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,458 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-22 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 555 | 🌐 TypeScript | 📅 2026-08-22 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,759 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [tuql](https://github.com/bradleyboy/tuql) ⭐ 1,075 | 🐛 15 | 🌐 JavaScript | 📅 2021-06-06 - Automatically create a GraphQL server from any sqlite database.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-21 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,674 | 🐛 1,126 | 🌐 Rust | 📅 2026-08-22
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,746 | 🐛 695 | 🌐 Go | 📅 2026-08-22 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 23,250 | 🐛 246 | 🌐 Python | 📅 2026-08-21 - GraphQL-first headless e-commerce platform.
